...
def seleccionar_clave_aleatoria_por_letra(lista_palabras,letra):
    """
    La funcion recibe como parametro un lista_palabras y una letra y devuelve una palabra aleatoria
    que empieza con la letra recibida
    Parametros:
            lista_palabras:lista
            letra:caracter
    return: palabra_aleatoria_elegida:caracter
    """
    INICIAL = 0
...
def obtener_lista_palabras(lista_palabras,letras_participantes):
    ...
    Parametros:
            lista_palabras:lista
            letras_participantes:lista
    return: lista_palabras_elegidas:lista
